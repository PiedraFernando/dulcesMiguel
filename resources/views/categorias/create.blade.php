                    ...
                    <div class="card-body">
                        <form method="POST" action="/categorias">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="sub_categoria" type="text" class="form-control @error('sub_categoria') is-invalid @enderror" name="sub_categoria" value="{{ old('sub_categoria') }}" required autocomplete="sub_categoria" autofocus>
